...
echo "  --build-arg GRIDCOIN_DEB_URL=https://github.com/gridcoin-community/Gridcoin-Research/releases/download/5.4.9.0/gridcoinresearchd_5.4.9.0.trixie-1_amd64.deb \\"
echo "  ."
echo ""
echo "# For Debian 12 (Bookworm):"
echo "docker build -t gridcoin-deb \\"
echo "  --build-arg GRIDCOIN_DEB_URL=https://github.com/gridcoin-community/Gridcoin-Research/releases/download/5.4.9.0/gridcoinresearchd_5.4.9.0.bookworm-1_amd64.deb \\"
echo "  ."
echo ""
